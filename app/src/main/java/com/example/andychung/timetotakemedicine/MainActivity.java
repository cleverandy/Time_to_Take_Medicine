package com.example.andychung.timetotakemedicine;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_Schedule) {
            ...
            Toast.makeText(this, "nav_Medicine", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this, "Medical Records", Toast.LENGTH_SHORT).show();
            MedicalRecoedFragment medicalRecoedFragment = new MedicalRecoedFragment();
            FragmentManager manager = getSupportFragmentManager();
            manager.beginTransaction().replace(
                    R.id.relativelayout_for_fragment,
                    medicalRecoedFragment,
                    medicalRecoedFragment.getTag()
            ).commit();
